...
- (void)addPullDownRefreshBlock:(void (^)(void))actionHandler
  ...
  if (!self.pullToRefreshView) {
    ...
    PullDownRefreshView *view = [[PullDownRefreshView alloc]
        initWithFrame:CGRectMake(0, yOrigin, self.bounds.size.width,
...
#warning Original method has been deprecated.Fixed two 'Size' as below -- LEO
...
//            lineBreakMode:self.titleLabel.lineBreakMode];
    ...
    CGSize titleSize = [self.titleLabel.text
                        boundingRectWithSize:CGSizeMake(labelMaxWidth, self.titleLabel.font.lineHeight)
...
//            lineBreakMode:self.subtitleLabel.lineBreakMode];
    ...
    paragraphStyle2.lineBreakMode = self.subtitleLabel.lineBreakMode;
    NSDictionary *attrDic2 = @{
                            NSFontAttributeName: self.subtitleLabel.font,
                            NSParagraphStyleAttributeName: paragraphStyle2};
    
    CGSize subtitleSize = [self.subtitleLabel.text
                           boundingRectWithSize:CGSizeMake(labelMaxWidth, self.subtitleLabel.font.lineHeight)
...
- (void)setState:(PullDownRefreshState)newState {
  ...
  case PullDownRefreshStateLoading:
    ...
    if (previousState == PullDownRefreshStateTriggered &&
